...
--Command     : generate_target bd_33ae.bd
--Design      : bd_33ae
...
entity bd_33ae is
  ...
  attribute CORE_GENERATION_INFO of bd_33ae : entity is "bd_33ae,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_33ae,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=2,numReposBlks=2,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_33ae : entity is "orx_test_bd_system_ila_1_0.hwdef";
end bd_33ae;

architecture STRUCTURE of bd_33ae is
  component bd_33ae_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 3 downto 0 );
    probe1 : in STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  end component bd_33ae_ila_lib_0;
  component bd_33ae_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_33ae_g_inst_0;
  ...
  signal probe1_1 : STD_LOGIC_VECTOR ( 2 downto 0 );
...
begin
  ...
  probe1_1(2 downto 0) <= probe1(2 downto 0);
  probe2_1(0) <= probe2(0);
  resetn_1 <= resetn;
g_inst: component bd_33ae_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
...
ila_lib: component bd_33ae_ila_lib_0
     port map (
      clk => clk_1,
      probe0(3 downto 0) => probe0_1(3 downto 0),
      probe1(2 downto 0) => probe1_1(2 downto 0),
      probe2(0) => probe2_1(0),
      probe3(31 downto 0) => net_slot_0_axis_tdata(31 downto 0),
