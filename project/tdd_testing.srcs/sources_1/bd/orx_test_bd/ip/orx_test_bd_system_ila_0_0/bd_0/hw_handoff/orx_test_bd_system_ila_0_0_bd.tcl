...
################################################################
# This is a generated script based on design: bd_f3ff
#
...
CONFIG.ASSOCIATED_RESET {resetn} \
  ...
  set probe3 [ create_bd_port -dir I -from 1 -to 0 probe3 ]
  set probe4 [ create_bd_port -dir I -from 1 -to 0 probe4 ]
  set probe5 [ create_bd_port -dir I -from 1 -to 0 probe5 ]
